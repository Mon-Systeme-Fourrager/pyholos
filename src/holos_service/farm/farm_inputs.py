...
from holos_service.components.animals import beef
...
class AnimalInputBase:
    ...
    def create_components(self, **kwargs):
        pass
...
@dataclass
class DairyCattleInput:
    DairyHeifers: ManagementPeriods = None
    DairyLactatingCow: ManagementPeriods = None
    DairyCalves: ManagementPeriods = None
    DairyDryCow: ManagementPeriods = None
